function [kk,mat_k]=cal_kk_FSFEM_T4_aver(sdof,nel,face_data,nodes,gcoord,vol_tetra,nnel,ndof,matmtx,vol_face)
...
for ifa = 1:nface                          
    ...
    [nodL,BL] = formBmat_FSFEM_T4_aver(face_data(ifa,:),vol_tetra,mat_B,ne,nodes,vol_face(ifa));  
    k=BL'*matmtx*BL*vol_face(ifa);                    % element stiffness matrice   
